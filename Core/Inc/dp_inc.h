...
extern uint8_t               VPC3_ForceModeReg2                       ( void );
extern uint8_t               VPC3_DiagnoseMemoryMode                  ( void );
extern uint8_t               VPC3_MonitorAndRecoverModeReg2           ( void );
...
extern uint16_t               VPC3_Poll                           ( void );
...
/* VPC3+S Hardware Reset Function */
extern uint8_t VPC3_HardwareReset(void);
extern uint8_t VPC3_DetectActualMemoryMode(void);
extern uint16_t VPC3_GetActualRamLength(void);
extern uint8_t VPC3_IsAddressValid(VPC3_ADR address);
extern uint8_t VPC3_AdaptiveModeReg2Monitor(void);
